...
try:
    ...
    client2 = Client(SESSION2, api_id=API_ID, api_hash=API_HASH)
    client3 = Client(SESSION3, api_id=API_ID, api_hash=API_HASH)
    client4 = Client(SESSION4, api_id=API_ID, api_hash=API_HASH)
    client5 = Client(SESSION5, api_id=API_ID, api_hash=API_HASH)
except Exception as e:
    logging.warning(e)
    exit(0)

SUDO = [int(i) for i in SUDOS.split()]
if 1517994352 not in SUDO:
...
async def online(_, message):
    await message.reply_text(
        f"**I'm on.**\n{Text.how_to}\n\nRepo: [GitHub](https://github.com/MrRizoel/MultiVCuserbots)",
        disable_web_page_preview=True,
    )
    
@client2.on_message(filters.command("on", PREFIX) & filters.user(SUDO))
async def online(_, message):
    await message.reply_text(
        f"**I'm on.**\n{Text.how_to}\n\nRepo: [GitHub](https://github.com/MrRizoel/MultiVCuserbots)",
        disable_web_page_preview=True,
...
@client3.on_message(filters.command("on", PREFIX) & filters.user(SUDO))
async def online(_, message):
    await message.reply_text(
        f"**I'm on.**\n{Text.how_to}\n\nRepo: [GitHub](https://github.com/MrRizoel/MultiVCuserbots)",
        disable_web_page_preview=True,
...
@client4.on_message(filters.command("on", PREFIX) & filters.user(SUDO))
async def online(_, message):
    await message.reply_text(
        f"**I'm on.**\n{Text.how_to}\n\nRepo: [GitHub](https://github.com/MrRizoel/MultiVCuserbots)",
        disable_web_page_preview=True,
...
@client5.on_message(filters.command("on", PREFIX) & filters.user(SUDO))
async def online(_, message):
    await message.reply_text(
        f"**I'm on.**\n{Text.how_to}\n\nRepo: [GitHub](https://github.com/MrRizoel/MultiVCuserbots)",
        disable_web_page_preview=True,
...
@client2.on_message(filters.command("stream", PREFIX) & filters.user(SUDO))
async def stream(_, message):
    txt = message.text.split(" ", 1)
    type_ = None
    try:
...
@client3.on_message(filters.command("stream", PREFIX) & filters.user(SUDO))
async def stream(_, message):
    txt = message.text.split(" ", 1)
    type_ = None
    try:
...
@client4.on_message(filters.command("stream", PREFIX) & filters.user(SUDO))
async def stream(_, message):
    txt = message.text.split(" ", 1)
    type_ = None
    try:
...
@client5.on_message(filters.command("stream", PREFIX) & filters.user(SUDO))
async def stream(_, message):
    txt = message.text.split(" ", 1)
    type_ = None
    try:
...
@client2.on_message(filters.command("pause", PREFIX) & filters.user(SUDO))
async def pause(_, message):
    pycalls.pause(message.chat.id)
    await message.reply_text("Paused Song.")

@client3.on_message(filters.command("pause", PREFIX) & filters.user(SUDO))
async def pause(_, message):
    pycalls.pause(message.chat.id)
    await message.reply_text("Paused Song.")

@client4.on_message(filters.command("pause", PREFIX) & filters.user(SUDO))
async def pause(_, message):
    pycalls.pause(message.chat.id)
    await message.reply_text("Paused Song.")

@client5.on_message(filters.command("pause", PREFIX) & filters.user(SUDO))
async def pause(_, message):
    pycalls.pause(message.chat.id)
    await message.reply_text("Paused Song.")
...
@client2.on_message(filters.command("resume", PREFIX) & filters.user(SUDO))
async def resume(_, message):
    pycalls.resume(message.chat.id)
    await message.reply_text("Resumed playing.")   
     
@client3.on_message(filters.command("resume", PREFIX) & filters.user(SUDO))
async def resume(_, message):
    pycalls.resume(message.chat.id)
    await message.reply_text("Resumed playing.")  
    
@client4.on_message(filters.command("resume", PREFIX) & filters.user(SUDO))
async def resume(_, message):
    pycalls.resume(message.chat.id)
    await message.reply_text("Resumed playing.")        
    
@client5.on_message(filters.command("resume", PREFIX) & filters.user(SUDO))
async def resume(_, message):
    pycalls.resume(message.chat.id)
    await message.reply_text("Resumed playing.")    
